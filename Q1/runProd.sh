...
java -classpath $c com.kohls.recommendations.r.RecommendRunner  --local --input o1/com.kohls.recommendations-products.csv --inRCats o1/recomdsCats.csv --inPrice o1/price.csv --debug true  --output o1/pr-podcustAfterJoin3.csv
